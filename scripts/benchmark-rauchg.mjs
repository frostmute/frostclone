...
async function main() {
  const targetUrl = "https://rauchg.com";
  const destDir = path.join(os.homedir(), "Projects", "rauchg-clone");
  ...
  console.log(`\n========================================`);
  console.log(`  FROSTCLONE BENCHMARK: RAUCHG.COM`);
  console.log(`========================================\n`);
  ...
  await fs.writeFile("docs/case-study/benchmark-rauchg.json", JSON.stringify(metrics, null, 2));
